...
export type CheckNotIndexedItems2TargetType =
  (typeof CheckNotIndexedItems2TargetType)[keyof typeof CheckNotIndexedItems2TargetType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CheckNotIndexedItems2TargetType = {
  FOLDER: 'FOLDER',
  URL: 'URL',
  DOCUMENT: 'DOCUMENT',
  IMAGE: 'IMAGE',
