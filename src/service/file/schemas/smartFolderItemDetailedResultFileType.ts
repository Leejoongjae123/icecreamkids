 ...
 */
export type SmartFolderItemDetailedResultFileType =
  (typeof SmartFolderItemDetailedResultFileType)[keyof typeof SmartFolderItemDetailedResultFileType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SmartFolderItemDetailedResultFileType = {
  FOLDER: 'FOLDER',
  URL: 'URL',
  DOCUMENT: 'DOCUMENT',
  IMAGE: 'IMAGE',
