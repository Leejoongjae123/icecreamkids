 ...
 */
export type SmartFolderItemResultFileType =
  (typeof SmartFolderItemResultFileType)[keyof typeof SmartFolderItemResultFileType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SmartFolderItemResultFileType = {
  FOLDER: 'FOLDER',
  URL: 'URL',
  DOCUMENT: 'DOCUMENT',
  IMAGE: 'IMAGE',
