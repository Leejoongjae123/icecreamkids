      ...
      <div className="flex overflow-hidden flex-col items-center px-3 py-2 flex-1 w-full leading-none bg-white rounded-md border border-dashed border-zinc-400 min-h-0 justify-center">
        <div className="flex gap-1.5 w-4/5 mb-2"> 
          <Input
            ...
            className="h-[27px] px-2 py-1.5 text-xs tracking-tight bg-white border border-zinc-100 text-zinc-400 placeholder-zinc-400 flex-1 shadow-none !rounded-md focus:ring-0 focus-visible:ring-0 focus:outline-none focus:border-primary focus:border-2"
